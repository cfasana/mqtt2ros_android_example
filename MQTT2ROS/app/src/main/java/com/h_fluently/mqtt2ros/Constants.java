...
public class Constants {
    public static final String MQTT_BROKER_URI = "tcp://10.170.10.13:1883";
    ...
    public static final String MQTT_SUBSCRIPTION_TOPIC = "mqtt/ros2mqtt_msg";
    public static final String MQTT_PUBLISHED_TOPIC = "mqtt/mqtt2ros_msg";
